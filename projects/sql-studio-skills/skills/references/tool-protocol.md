...
Until Server DTOs freeze, **no MCP/HTTP tool in this list is live**. Skills must not pretend otherwise.
...
Destructive/Administrative require plan hash, fingerprints, short-lived grant, human approval, and audit — not chat
“确认执行”.
